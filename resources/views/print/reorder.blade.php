...
<body>
    ...
    <div style="font-family:Calibri;">
        ...
        <center style="font-size: 8px; margin-bottom: 10px; font-family:Arial, Helvetica, sans-serif;">REORDER REPORT</center>
        ...
        <table style="width:100%; font-size: 10px; padding: 20px; font-family:Arial, Helvetica, sans-serif">
            ...
            <tbody>
                ...
                <tr>
                    <td><center>{{$session['code']}}</center></td>
                    <td class="nor"><center>{{$session['name']}}</center></td>
                    <td class="nor"><center>{{$session['stock']}}</center></td>
                    <td class="nor"><center>{{$session['reorder']}}</center></td>
